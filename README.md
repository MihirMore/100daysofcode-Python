...
## Rules: Code everyday for atleast an hour for 100 days straight. Post this on twitter under #100daysofcode (I don't tweet :grin:)
...
- [Source-Code](https://github.com/MihirMore/100daysofcode-Python/tree/main/Day-23/Capstone-Project-2/turtle-crossing-game)
- [Live-Version](https://replit.com/@MihirMore1/Crossy-Road#main.py)

### Day - 24

- Project Name: **Mail Merge**
- Description: I have a scenario where I've to send birthday invitations to my friends, however, I'm quite busy and want to automate the process of writing the names of friends in a file where I have already created a template. So, this script will run and create the invitations ready to be send to my friends and I've saved lot of time :innocent:
- [Source-Code](https://github.com/MihirMore/100daysofcode-Python/tree/main/Day-24/Mail_Merge)
...
- [Source-Code](https://github.com/MihirMore/100daysofcode-Python/tree/main/Day-29/Final-Project/Password_Manager)
- [Live Version](https://replit.com/@MihirMore1/Password-Generator#main.py)

### Day - 30

- Project-Name: **Password Generator V-2.0**
...
- [Source-Code](https://github.com/MihirMore/100daysofcode-Python/tree/main/Day-38/Workout-Tracker)
- [Live Version](https://replit.com/@MihirMore1/Workout-Tracker#main.py)

### Day - 39

- Project-Name: **Flight Club - I**
...
- [Source-Code](https://github.com/MihirMore/100daysofcode-Python/tree/main/Day-39/Flight-Deals-Alerts)
- [Live Version](https://replit.com/@MihirMore1/Flight-Club-I#main.py)

### Day - 40

- Project-Name: **Flight Club**
- **Description** : This project is a capstone project wherein we develop a Flight application which will send us notifications when flight prices are less then we have entered for the next six months. This application uses Sheety API to read/write data stored in our google sheets. Also, we have used Tequila by kiwi API to fetch IATA codes for destination cities as well as to fetch flight data. We have created a customer acquisition console application where users have to enter their emails and will recieve flight deals via email as shown [here](https://github.com/MihirMore/100daysofcode-Python/blob/main/Day-40/flight-deals-II/Email%20notification.png) :airplane:
- [Source Code](https://github.com/MihirMore/100daysofcode-Python/tree/main/Day-40/flight-deals-II)
